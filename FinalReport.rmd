...
As per the graph, almost 68% of both "white" race favor capital punishment while 32% oppose it. Meanwhile  "other" race has a more significant amount of people who are for capital punishment, 56% are in favor while, 44% are not. The "black" race on the other hand had a result of 46% are in favor while 54% are not.
...
The major contribution came from the "black" race on the chi sq test as per the table above specifically on the 3rd table.  
